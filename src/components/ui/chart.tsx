...
function getPayloadConfigFromPayload(
  ...
  if (key.includes(".")) {
    ...
    realKey = keyParts[keyParts.length - 1] as string
  }

  if (
    realKey in config &&
    typeof config[realKey] === "object" &&
    config[realKey] !== null
  ) {
  ...
  if (
    payloadPayload &&
    realKey in payloadPayload &&
    typeof payloadPayload[realKey as keyof typeof payloadPayload] === "object"
  ) {
    return payloadPayload[realKey as keyof typeof payloadPayload]
  }
